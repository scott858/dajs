...
/**
   ...
   * @notes Grid is the main viewModel.  Any properties or methods needed to maintain state are defined in
 * * this prototype.  One instance of Grid is created per Grid directive instance.
   ...
   * @notes set to true when Grid is scrolling vertically. Set to false via debounced method
   */
   ...
   * @propertyOf ui.grid.class:Grid
   * @notes set to true when Grid is scrolling horizontally. Set to false via debounced method
   */
   ...
   * @notes sets isScrollingVertically to true and sets it to false in a debounced function
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes sets isScrollingHorizontally to true and sets it to false in a debounced function
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes When the build creates columns from column definitions, the columnbuilders will be called to add
   ...
   * @methodOf ui.grid.class:Grid
   * @notes Populates columnDefs from the provided data
   ...
   * @methodOf ui.grid.class:Grid
   * @notes When the build creates rows from gridOptions.data, the rowBuilders will be called to add
   ...
   * @name getColumn
   * @methodOf ui.grid.class:Grid
   * @notes returns a grid column for the column name
   ...
   * @name getColDef
   * @methodOf ui.grid.class:Grid
   * @notes returns a grid colDef for the column name
   ...
   * @name assignTypes
   * @methodOf ui.grid.class:Grid
   * @notes uses the first row of data to assign colDef.type for any types not defined.
   */
   ...
   * @name buildColumns
   * @methodOf ui.grid.class:Grid
   * @notes creates GridColumn objects from the columnDefinition.  Calls each registered
 ...
 * @methodOf ui.grid.class:Grid
 * @notes precompiles all cell templates
 */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes creates the left render container if it doesn't already exist
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes creates the right render container if it doesn't already exist
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes defaults the name property from field to maintain backwards compatibility with 2.x
  ...
  // Return a list of items that exist in the `n` array but not the `o` array. Uses optional property accessors passed as third & fourth parameter_set
  Grid.prototype.newInN = function newInN(o, n, oAccessor, nAccessor) {
     ...
     * @name getRow
     * @methodOf ui.grid.class:Grid
     * @notes returns the GridRow that contains the rowEntity
   ...
   * @name modifyRows
   * @methodOf ui.grid.class:Grid
   * @notes creates or removes GridRow objects from the newRawData array.  Calls each registered
   ...
   * @name addRows
   * @methodOf ui.grid.class:Grid
   * @notes adds the newRawData array of rows to the grid and calls all registered
   ...
   * @methodOf ui.grid.class:Grid
   * @notes processes all RowBuilders for the gridRow
   ...
   * @methodOf ui.grid.class:Grid
   * @notes registered a styleComputation function
   * 
   ...
   * @methodOf ui.grid.class:Grid
   * @param {function(renderableRows)} rows processor function
   * @notes Remove a registered rows processor
   */
   ...
   * @notes Run all the registered rows processors on the array of renderable rows
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes Triggered when the browser window resizes; automatically resizes the grid
   */
   ...
   * @name buildStyles
   * @methodOf ui.grid.class:Grid
   * @notes calls each styleComputation function
   */
   ...
   * @methodOf ui.grid.class:Grid
   * @notes Return the columns that the grid is currently being sorted by
   ...
   * @name sortColumn
   * @methodOf ui.grid.class:Grid
   * @notes Set the sorting on a given column, optionally resetting any existing sorting on the Grid.
