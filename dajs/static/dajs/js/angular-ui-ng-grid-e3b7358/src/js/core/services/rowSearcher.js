 ...
 *
 *  @notes Service for searching/filtering rows based on column value conditions.
 */
module.service('rowSearcher', ['$log', 'uiGridConstants', function ($log, uiGridConstants) {
   ...
   * @notes Get the term from a filter
   ...
   * @name stripTerm
   * @methodOf ui.grid.service:rowSearcher
   * @notes Remove leading and trailing asterisk (*) from the filter's term
   * @param {object} filter object to use
   ...
   * @name guessCondition
   * @methodOf ui.grid.service:rowSearcher
   * @notes Guess the condition for a filter based on its term
   * <br>
   ...
   * @name searchColumn
   * @methodOf ui.grid.service:rowSearcher
   * @notes Process filters on a given column against a given row. If the row meets the conditions on all the filters, return true.
