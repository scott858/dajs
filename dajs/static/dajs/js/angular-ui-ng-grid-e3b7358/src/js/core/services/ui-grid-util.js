...
module.service('gridUtil', ['$log', '$window', '$document', '$http', '$templateCache', '$timeout', '$injector', '$q', 'uiGridConstants',
  ...
  var s = {
     ...
     * @methodOf ui.grid.service:GridUtil
     * @notes Return a list of column names, given a data set
     *
     ...
     * @name newId
     * @methodOf ui.grid.service:GridUtil
     * @notes Return a unique ID string
     *
     ...
     * @name getTemplate
     * @methodOf ui.grid.service:GridUtil
     * @notes Get's template from cache / element / url
     *
     ...
     * @name guessType
     * @methodOf ui.grid.service:GridUtil
     * @notes guesses the type of an argument
     *
