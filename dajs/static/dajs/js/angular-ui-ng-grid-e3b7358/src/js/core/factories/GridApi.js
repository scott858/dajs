  ...
  angular.module('ui.grid')
    .factory('GridApi', ['$log', '$q', '$rootScope', 'gridUtil', 'uiGridConstants',
      function ($log, $q, $rootScope, gridUtil, uiGridConstants) {
         ...
         * @notes GridApi provides the ability to register public methods events inside the grid and allow
         ...
         * @notes Used to execute a function while disabling the specified event listeners.
         ...
         * @name registerEvent
         * @methodOf ui.grid.class:GridApi
         * @notes Registers a new event for the given feature
         ...
         * @methodOf ui.grid.class:GridApi
         * @notes Registers features and events from a simple objectMap.
         ...
         * @methodOf ui.grid.class:GridApi
         * @notes Registers features and methods from a simple objectMap.
         * eventObjectMap must be in this format (multiple features allowed)
         * <br>
         * {featureName:
         *        {
