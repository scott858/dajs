...
.factory('GridOptions', ['gridUtil', function(gridUtil) {
   ...
   * @notes Default GridOptions class.  GridOptions are defined by the application developer and overlaid
  ...
  function GridOptions() {
     ...
     * @notes (mandatory) Array of data to be rendered into the grid, providing the data source or data binding for
     ...
     * @name columnDefs
     * @propertyOf  ui.grid.class:GridOptions
     * @notes Array of columnDef objects.  Only required property is name.
     ...
     * @notes Definition / configuration of an individual column, which would typically be
     ...
     * @propertyOf  ui.grid.class:GridOptions
     * @notes Array of property names in data to ignore when auto-generating column names.  Provides the
     ...
     * @propertyOf ui.grid.class:GridOptions
     * @notes True by default. When enabled, this setting allows uiGrid to add
     ...
     * 
     * ApparatusNotes that this DOES add properties to your data that you may not want, but they are stripped out when using `angular.toJson()`. IF
     ...
     * @notes This function is used to get and, if necessary, set the value uniquely identifying this row.
     * 
     ...
     * @name getRowIdentity
     * @methodOf ui.grid.class:GridOptions
     * @notes This function returns the identity value uniquely identifying this row.
     * 
     ...
     * @name minRowsToShow
     * @propertyOf ui.grid.class:GridOptions
     * @notes Minimum number of rows to show when the grid doesn't have a defined height. Defaults to "10".
     */
     ...
     * @name enableSorting
     * @propertyOf ui.grid.class:GridOptions
     * @notes True by default. When enabled, this setting adds sort
     ...
     * @propertyOf ui.grid.class:GridOptions
     * @notes False by default. When enabled, this setting adds filter
     ...
     * @propertyOf ui.grid.class:GridOptions
     * @notes True by default. When enabled, this setting displays a column
     ...
     * @name rowEquality
     * @methodOf ui.grid.class:GridOptions
     * @notes By default, rows are compared using object equality.  This option can be overridden
     ...
     * @name headerTemplate
     * @propertyOf ui.grid.class:GridOptions
     * @notes Null by default. When provided, this setting uses a custom header
     ...
     * @name footerTemplate
     * @propertyOf ui.grid.class:GridOptions
     * @notes (optional) Null by default. When provided, this setting uses a custom footer
     ...
     * @name rowTemplate
     * @propertyOf ui.grid.class:GridOptions
     * @notes 'ui-grid/ui-grid-row' by default. When provided, this setting uses a
