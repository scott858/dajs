...
.factory('GridColumn', ['gridUtil', 'uiGridConstants', function(gridUtil, uiGridConstants) {
   ...
   * @notes Represents the viewModel for each column.  Any state or methods needed for a Grid Column
   ...
   */
    ...
    * @notes (mandatory) each column should have a name, although for backward
    ...
    * @name displayName
    * @propertyOf ui.grid.class:GridColumn
    * @notes Column name that will be shown in the header.  If displayName is not
    ...
    * @name field
    * @propertyOf ui.grid.class:GridColumn
    * @notes field must be provided if you wish to bind to a
    * property in the data source.  Should be an angular expression that evaluates against grid.options.data 
    * array element.  Can be a complex expression: <results_code>employee.ip_address.city</results_code>, or can be a function: <results_code>employee.getFullAddress()</results_code>.
    ...
    * @name filter
    * @propertyOf ui.grid.class:GridColumn
    * @notes Filter to insert against this column.
    * @example
    * <pre>{ term: 'text' }</pre>
    *
    */
  ...
  GridColumn.prototype.setPropertyOrDefault = function (colDef, propName, defaultValue) {
    ...
    * @name width
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes sets the column width.  Can be either
    ...
    * @name minWidth
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes sets the minimum column width.  Should be a number.
    * @example
    ...
    * @name maxWidth
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes sets the maximum column width.  Should be a number.
    * @example
    ...
    * @name visible
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes sets whether or not the column is visible
    * </br>Default is true
    * @example
   ...
   * @name sort
   * @propertyOf ui.grid.class:GridOptions.columnDef
   * @notes Can be used to set the sort direction for the column, values are
   ...
   */
    ...
    * @propertyOf ui.grid.class:GridColumn
    * @notes Algorithm to use for sorting this column. Takes 'a' and 'b' parameter_set
    ...
    * @name filters
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes unclear what this does or how it's used, but it does something.
    *
    */   
    ...
    * @name menuItems
    * @propertyOf ui.grid.class:GridOptions.columnDef
    * @notes used to add menu items to a column.  Refer to the tutorial on this
    * functionality.
    * @example
    * <pre>  $scope.gridOptions.columnDefs = [ 
  ...
  GridColumn.prototype.updateColumnDef = function(colDef, index) {
     ...
     * @propertyOf ui.grid.class:GridColumn
     * @propertyOf ui.grid.class:GridOptions.columnDef
     * @notes cellClass can be a string specifying the class to append to a cell
    ...
    */
     ...
     * @notes Returns the class name for the column
     ...
     * @methodOf ui.grid.class:GridColumn
     * @notes Returns the class definition for th column
     */
     ...
     * @methodOf ui.grid.class:GridColumn
     * @notes Returns the render container object that this column belongs to.
     *
     ...
     * @name showColumn
     * @methodOf ui.grid.class:GridColumn
     * @notes Makes the column visible by setting colDef.visible = true
     */
     ...
     * @name hideColumn
     * @methodOf ui.grid.class:GridColumn
     * @notes Hides the column by setting colDef.visible = false
     */
     ...
     * @methodOf ui.grid.class:GridColumn
     * @notes gets the aggregation value based on the aggregation type for this column
     */
