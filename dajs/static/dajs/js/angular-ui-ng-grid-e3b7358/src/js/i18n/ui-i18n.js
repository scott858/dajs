...
(function () {
   ...
   *
   *  @notes constants available in i18n module
   */
  ...
  module.service('i18nService', ['$log', 'i18nConstants', '$rootScope',
    function ($log, i18nConstants, $rootScope) {
      ...
      var service = {
         ...
         * @notes  Adds the languages and strings to the cache. Decorate this service to
         ...
         *         },
         *         groupPanel: {
         *              notes: 'Drag a column header here and drop it to group by that column.'
         *           }
         *      }
         * </pre>
         */
         ...
         * @name getAllLangs
         * @methodOf ui.grid.i18n.service:i18nService
         * @notes  return all currently loaded languages
         ...
         * @name getSafeText
         * @methodOf ui.grid.i18n.service:i18nService
         * @notes  returns the text specified in the path or a Missing text if text is not found
         ...
         * @name setCurrentLang
         * @methodOf ui.grid.i18n.service:i18nService
         * @notes sets the current language to use in the application
         ...
         * @name getCurrentLang
         * @methodOf ui.grid.i18n.service:i18nService
         * @notes returns the current language used in the application
         */
        getCurrentLang: function () {
