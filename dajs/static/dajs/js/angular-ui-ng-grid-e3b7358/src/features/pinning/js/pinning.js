  ...
  module.service('uiGridPinningService', ['$log', 'GridRenderContainer', 'i18nService', function ($log, GridRenderContainer, i18nService) {
    var service = {
      ...
      defaultGridOptions: function (gridOptions) {
         ...
         *
         *  @notes GridOptions for pinning feature, these are available to be
         ...
         *  @notes Enable pinning for the entire grid.
         *  <br/>Defaults to true
         */
      ...
      pinningColumnBuilder: function (colDef, col, gridOptions) {
         ...
         *
         *  @notes ColumnDef for pinning feature, these are available to be
         ...
         *  @notes Enable pinning for the individual column.
         *  <br/>Defaults to true
         */
         ...
         *  @name pinnedLeft
         *  @propertyOf  ui.grid.pinning.api:ColumnDef
         *  @notes Column is pinned left when grid is rendered
         ...
         *  @name pinnedRight
         *  @propertyOf  ui.grid.pinning.api:ColumnDef
         *  @notes Column is pinned right when grid is rendered
         *  <br/>Defaults to false
         */
