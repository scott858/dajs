(function () {
   ...
   *
   *  @notes constants available in edit module
   */
   ...
   *
   *  @notes Services for editing features
   */
    ...
    function ($log, $q, $templateCache, uiGridConstants, gridUtil) {
      ...
      var service = {
        ...
        initializeGrid: function (grid) {
           ...
           *
           *  @notes Public Api for edit feature
           */
          var publicApi = {
            events: {
              edit: {
                 ...
                 * @notes raised when cell editing is complete
                 * <pre>
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *
           *  @notes Options for configuring the edit feature, these are available to be
           ...
           *  @notes If defined, sets the default value for the editable flag on each individual colDefs
           ...
           *  @propertyOf  ui.grid.edit.api:GridOptions
           *  @notes If specified, either a value or function to be used by all columns before editing.
           ...
           *  @propertyOf  ui.grid.edit.api:GridOptions
           *  @notes If specified, cellTemplate to use as the editor for all columns.
           ...
           *  @propertyOf  ui.grid.edit.api:GridOptions
           *  @notes If true, then editor is invoked as soon as cell receives focus. Default false.
         ...
         * @notes columnBuilder function that adds edit properties to grid column
        ...
        editColumnBuilder: function (colDef, col, gridOptions) {
           ...
           *
           *  @notes Column Definition for edit feature, these are available to be
           ...
           *  @notes enable editing on column
           */
           ...
           *  @name cellEditableCondition
           *  @propertyOf  ui.grid.edit.api:ColumnDef
           *  @notes If specified, either a value or function evaluated before editing cell.  If falsy, then editing of cell is not allowed.
           *  @example 
           *  <pre>
           *  function($scope){
           *    //use $scope.row.entity and $scope.col.colDef to determine if editing is allowed
           ...
           *  @name editableCellTemplate
           *  @propertyOf  ui.grid.edit.api:ColumnDef
           *  @notes cell template to be used when editing this column. Can be Url or text template
         ...
         * @name isStartEditKey
         * @methodOf ui.grid.edit.service:uiGridEditService
         * @notes  Determines if a keypress should start editing.  Decorate this service to override with your
   ...
   *  @restrict A
   *
   *  @notes Adds editing features to the ui-grid directive.
   *
   *  @example
   <example module="app">
   <file name="app.js">
   ...
   *  @restrict A
   *
   *  @notes Stacks on top of ui.grid.uiGridCell to provide in-line editing capabilities to the cell
   *  Editing Actions.
   *
   ...
   *  @restrict A
   *
   *  @notes input editor directive for editable fields.
   ...
   *  @restrict E
   *
   *  @notes directive to provide binding between input[date] value and ng-model for angular 1.2
