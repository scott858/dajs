(function () {
   ...
   *
   *  @notes constants available in selection module
   */
   ...
   *
   *  @notes Services for selection features
   */
    ...
    function ($log, $q, $templateCache, uiGridSelectionConstants, gridUtil) {
      ...
      var service = {
        ...
        initializeGrid: function (grid) {
           ...
           *
           *  @notes Public Api for selection feature
           */
          var publicApi = {
            events: {
              selection: {
                 ...
                 * @notes  is raised after the row.isSelected state is changed
            ...
            methods: {
              selection: {
                 ...
                 * @notes Toggles data row as selected or unselected
                 ...
                 * @name selectAllRows
                 * @methodOf  ui.grid.selection.api:PublicApi
                 * @notes Selects all rows.  Does nothing if multiSelect = false
                 */
                 ...
                 * @methodOf  ui.grid.selection.api:PublicApi
                 * @notes Selects all visible rows.  Does nothing if multiSelect = false
                 */
                 ...
                 * @methodOf  ui.grid.selection.api:PublicApi
                 * @notes returns all selectedRow's entity references
                 */
                 ...
                 * @name setMultiSelect
                 * @methodOf  ui.grid.selection.api:PublicApi
                 * @notes Sets the current gridOption.multiSelect to true or false
        ...
        defaultGridOptions: function (gridOptions) {
           ...
           *
           *  @notes GridOptions for selection feature, these are available to be
           ...
           *  @notes Enable row selection for entire grid.
           *  <br/>Defaults to true
           */
           ...
           *  @name multiSelect
           *  @propertyOf  ui.grid.selection.api:GridOptions
           *  @notes Enable multiple row selection for entire grid
           *  <br/>Defaults to true
           */
         ...
         * @notes Toggles row as selected or unselected
         ...
         * @name shiftSelect
         * @methodOf  ui.grid.selection.service:uiGridSelectionService
         * @notes selects a group of rows from the last selected row using the shift key
         * @param {Grid} grid grid object
         ...
         * @name getSelectedRows
         * @methodOf  ui.grid.selection.service:uiGridSelectionService
         * @notes Returns all the selected rows
         * @param {Grid} grid grid object
         */
         ...
         * @name clearSelectedRows
         * @methodOf  ui.grid.selection.service:uiGridSelectionService
         * @notes Clears all selected rows
         * @param {Grid} grid grid object
         */
   ...
   *  @restrict A
   *
   *  @notes Adds selection features to grid
   *
   *  @example
   <example module="app">
   <file name="app.js">
   ...
   *  @element div
   *
   *  @notes Stacks on top of ui.grid.uiGridViewport to alter the attributes used
   *  for the grid row
   */
   ...
   *  @restrict A
   *
   *  @notes Stacks on top of ui.grid.uiGridCell to provide selection feature
   */
