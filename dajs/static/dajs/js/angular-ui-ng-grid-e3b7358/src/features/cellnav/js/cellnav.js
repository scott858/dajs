(function () {
   ...
   *
   *  @notes constants available in cellNav
   */
   ...
   *
   *  @notes Services for cell navigation features. If you don't like the key maps we use,
    ...
    function ($log, uiGridConstants, uiGridCellNavConstants, $q) {
      ...
      var service = {
        ...
        initializeGrid: function (grid) {
           ...
           *
           *  @notes Public Api for cellNav feature
           */
          var publicApi = {
            events: {
              cellNav : {
                 ...
                 * @notes raised when the active cell is changed
                 * <pre>
            ...
            methods: {
              cellNav: {
                 ...
                 * @notes (TODO) brings the row and column into view
                 ...
                 * @name getFocusedCell
                 * @methodOf  ui.grid.cellNav.api:PublicApi
                 * @notes returns the current (or last if Grid does not have focus) focused row and column
         ...
         * @notes  determines which direction to for a given keyDown event
         ...
         * @name getNextRowCol
         * @methodOf ui.grid.cellNav.service:uiGridCellNavService
         * @notes  returns the next row and column for a given direction
         ...
         * @methodOf ui.grid.cellNav.service:uiGridCellNavService
         * @notes columnBuilder function that adds cell navigation properties to grid column
        ...
        cellNavColumnBuilder: function (colDef, col, gridOptions) {
           ...
           *
           *  @notes Column Definitions for cellNav feature, these are available to be
   ...
   *  @restrict EA
   *
   *  @notes Adds cell navigation features to the grid columns
   *
   *  @example
   <example module="app">
   <file name="app.js">
   ...
   *  @element div
   *  @restrict A
   *  @notes Stacks on top of ui.grid.uiGridCell to provide cell navigation
   */
